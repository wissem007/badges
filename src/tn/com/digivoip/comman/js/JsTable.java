...
public class JsTable implements Serializable,JsObject{
	...
	public boolean getBooleanValue(int index) {
		if (listValue.get(index) == null) { return false; }
		return Boolean.getBoolean(listValue.get(index));
	}
	public int getIntValue(int index) {
		if (listValue.get(index) == null) { return 0; }
		return Integer.parseInt(listValue.get(index));
	}
	public String getStringValue(int index) {
		if (listValue.get(index) == null) { return ""; }
