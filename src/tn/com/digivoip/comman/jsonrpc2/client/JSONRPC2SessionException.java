...
public class JSONRPC2SessionException extends Exception{
	...
	/** Indicates the type of cause for this exception, see constants. */
	private int					causeType;
	
	/** Creates a new JSON-RPC 2.0 session exception with the specified message; the cause type is {@link #UNSPECIFIED}.
	 * @param message The message. */
	public JSONRPC2SessionException(final String message) {
		super(message);
		causeType = JSONRPC2SessionException.UNSPECIFIED;
	}
