...
public class RawResponse{
	 ...
	 * @param connection The URL connection, must be in state completed and not {@code null}.
	...
	/** Returns an unmodifiable Map of the header fields. The Map keys are Strings that represent the response header field names. Each Map value is an unmodifiable List of Strings that represents the
	 ...
	 * @return The value of the named header field, {@code null} if there is no such field in the header. */
	 ...
	 * @return The content length of the response, or -1 if the content length is not known. */
	 ...
	 * @return The content encoding of the response, or {@code null} if not known. */
