package tn.com.digivoip.comman.jsonrpc2.util;
 ...
 * <ul>
 * <li>{@code getXXX(param_name)} for mandatory parameters, where {@code XXX} is the expected parameter type.
 * <li>{@code getOptXXX(param_name, default_value)} for optional parameters, specifying a default value.
 * </ul>
 * <p>
 * There are also generic getter methods that let you do the type conversion yourself.
 * <p>
 * If a parameter cannot be retrieved, e.g. due to a missing mandatory parameter or bad type, a {@link tn.com.digivoip.comman.jsonrpc2.JSONRPC2Error#INVALID_PARAMS} exception is thrown.
 * <p>
...
public class NamedParamsRetriever
	...
	/** Throws a JSON-RPC 2.0 error indicating one or more missing named parameters.
	...
	private static void throwMissingParameterException(final String... names)
		...
		if (names.length == 1) { throw JSONRPC2Error.INVALID_PARAMS.
	...
	/** Throws a JSON-RPC 2.0 error indicating a named parameter with an unexpected {@code null} value.
	...
	/** Throws a JSON-RPC 2.0 error indicating a named parameter with an unexpected enumerated value.
	...
	/** Throws a JSON-RPC 2.0 error indicating a named parameter with an unexpected enumerated value.
	 * @param name The parameter name.
	 * @param enumClass The enumeration class specifying the acceptable string values. Must not be {@code null}.
	 * @throws JSONRPC2Error Formatted JSON-RPC 2.0 error. */
	...
	/** Creates a JSON-RPC 2.0 error indicating a named parameter with an unexpected JSON type.
	 * @param name The parameter name. Must not be {@code null}.
	...
	/** Returns {@code true} if a parameter by the specified name exists, else {@code false}.
	 * @param name The parameter name.
	...
	/** Returns {@code true} if the parameters by the specified names exist, else {@code false}.
	 * @param names The parameter names. Must not be {@code null}.
	...
	/** Returns {@code true} if the parameters by the specified mandatory names exist, {@code false} if any mandatory name is missing or a name outside the mandatory and optional is present.
	 * @param mandatoryNames The expected mandatory parameter names. Must not be {@code null}.
	 * @param optionalNames The expected optional parameter names, empty array or {@code null} if none.
	 * @return {@code true} if the specified mandatory names and only any of the optional are present, else {@code false}. */
	...
	/** Throws a {@code JSONRPC2Error.INVALID_PARAMS} if the specified names aren't present in the parameters, or names outside the specified are contained.
	 * <p>
	 * You may use this method to a fire a proper JSON-RPC 2.0 error on a missing or unexpected mandatory parameter name.
	 * @param mandatoryNames The expected parameter names. Must not be {@code null}.
	 * @throws JSONRPC2Error On a missing parameter name or names outside the specified ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	/** Throws a {@code JSONRPC2Error.INVALID_PARAMS} if the specified mandatory names aren't contained in the parameters, or names outside the specified mandatory and optional are present.
	 * <p>
	 * You may use this method to a fire a proper JSON-RPC 2.0 error on a missing or unexpected mandatory parameter name.
	 * @param mandatoryNames The expected mandatory parameter names. Must not be {@code null}.
	 * @param optionalNames The expected optional parameter names, empty array or {@code null} if none.
	 * @throws JSONRPC2Error On a missing mandatory parameter name or names outside the specified mandatory and optional ({@link JSONRPC2Error#INVALID_PARAMS}). */
	public void ensureParams(final String[] mandatoryNames,
			final String[] optionalNames)
			throws JSONRPC2Error {
	...
	/** Throws a {@code JSONRPC2Error.INVALID_PARAMS} exception if there is no parameter by the specified name.
	 * <p>
	 * You may use this method to fire the proper JSON-RPC 2.0 error on a missing mandatory parameter.
	 * @param name The parameter name.
	 * @throws JSONRPC2Error On a missing parameter ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	/** Throws a {@code JSONRPC2Error.INVALID_PARAMS} exception if there is no parameter by the specified name, its value is {@code null}, or its type doesn't map to the specified.
	 * <p>
	 * You may use this method to fire the proper JSON-RPC 2.0 error on a missing or badly-typed mandatory parameter.
	 * @param name The parameter name.
	 * @param clazz The corresponding Java class that the parameter should map to (any one of the return types of the {@code getXXX()} getter methods. Set to {@code Object.class} to allow any type.
	 * Must not be {@code null}.
	 * @throws JSONRPC2Error On a missing parameter, {@code null} value or bad type ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	/** Throws a {@code JSONRPC2Error.INVALID_PARAMS} exception if there is no parameter by the specified name or its type doesn't map to the specified.
	 * <p>
	 * You may use this method to fire the proper JSON-RPC 2.0 error on a missing or badly-typed mandatory parameter.
	 * @param name The parameter name.
	 * @param clazz The corresponding Java class that the parameter should map to (any one of the return types of the {@code getXXX()} getter methods. Set to {@code Object.class} to allow any type.
	 * Must not be {@code null}.
	 * @param allowNull If {@code true} allows a {@code null} parameter value.
	 * @throws JSONRPC2Error On a missing parameter or bad type ({@link JSONRPC2Error#INVALID_PARAMS}). */
	public <T> void ensureParam(final String name,
		...
		if (!clazz.isAssignableFrom(value.getClass())) { throw NamedParamsRetriever.newUnexpectedParameterTypeException(name); }
	}
	...
	/** Retrieves the specified parameter which can be of any type. Use this generic getter if you want to cast the value yourself. Otherwise look at the typed {@code get*} methods.
	 * @param name The parameter name.
	...
	/** Retrieves the specified optional parameter which must map to the provided class (use the appropriate wrapper class for primitive types). If the parameter doesn't exist the method returns the
	 * specified default value.
	 * @param name The parameter name.
	 * @param clazz The corresponding Java class that the parameter should map to (any one of the return types of the {@code getXXX()} getter methods. Set to {@code Object.class} to allow any type.
	 * Must not be {@code null}.
	 * @param defaultValue The default return value if the parameter doesn't exist. May be {@code null}.
	 * @return The parameter value.
	 * @throws JSONRPC2Error On a bad parameter type or {@code null} value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	 ...
	 * @param defaultValue The default return value if the parameter doesn't exist. May be {@code null}.
	 * @return The parameter value.
	 * @throws JSONRPC2Error On a bad parameter type ({@link JSONRPC2Error#INVALID_PARAMS}). */
	@SuppressWarnings("unchecked")
	 ...
	 * @throws JSONRPC2Error On a missing parameter, bad type or {@code null} value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	 ...
	 * @param defaultValue The default return value if the parameter doesn't exist. May be {@code null}.
	 * @return The parameter value as a string.
	 * @throws JSONRPC2Error On a bad type or {@code null} value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	 ...
	 * @param enumStrings The acceptable string values. Must not be {@code null}.
	 * @return The parameter value as a string.
	 * @throws JSONRPC2Error On a missing parameter, bad type or bad enumeration value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	public String getEnumString(final String name,
		...
		String match = ParamsRetriever.getEnumStringMatch(value, enumStrings, ignoreCase);
		if (match == null) {
	 ...
	 * @param defaultValue The default return value if the parameter doesn't exist. May be {@code null}.
	 * @return The parameter value as a string.
	 * @throws JSONRPC2Error On a bad type or bad enumeration value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	 ...
	 * @param name The parameter name.
	 * @param enumClass An enumeration type with constant names representing the acceptable string values. Must not be {@code null}.
	 ...
	 * @param name The parameter name.
	 * @param enumClass An enumeration type with constant names representing the acceptable string values. Must not be {@code null}.
	 * @param ignoreCase If {@code true} a case insensitive match against the acceptable constant names is performed.
	 * @return The matching enumeration constant.
	 * @throws JSONRPC2Error On a missing parameter, bad type or bad enumeration value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	public <T extends Enum<T>> T getEnum(final String name,
			...
			throws JSONRPC2Error {
		String value = get(name, String.class);
		T match = ParamsRetriever.getEnumStringMatch(value, enumClass, ignoreCase);
		if (match == null) {
	...
	/** Retrieves the specified optional enumerated parameter (from a JSON string that has a predefined set of possible values), allowing for a case insenstive match. If it doesn't exist the method
	 ...
	 * @param name The parameter name.
	 * @param defaultValue The default return value if the parameter doesn't exist.
	 * @return The parameter value as a {@code boolean}.
	 * @throws JSONRPC2Error On a bad parameter type or {@code null} value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	/** Retrieves the specified optional numeric parameter as an {@code int}. If it doesn't exist the method will return the specified default value.
	 * @param name The parameter name.
	 * @param defaultValue The default return value if the parameter doesn't exist.
	 * @return The parameter value as an {@code int}.
	 * @throws JSONRPC2Error On a bad parameter type or {@code null} value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	/** Retrieves the specified optional numeric parameter as a {@code long}. If it doesn't exist the method will return the specified default value.
	 * @param name The parameter name.
	 * @param defaultValue The default return value if the parameter doesn't exist.
	...
	/** Retrieves the specified optional numeric parameter as a {@code float}. If it doesn't exist the method will return the specified default value.
	 * @param name The parameter name.
	 * @param defaultValue The default return value if the parameter doesn't exist.
	 * @return The parameter value as a {@code float}.
	 * @throws JSONRPC2Error On a bad parameter type or {@code null} value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	/** Retrieves the specified optional numeric parameter as a {@code double}. If it doesn't exist the method will return the specified default value.
	 * @param name The parameter name.
	 * @param defaultValue The default return value if the parameter doesn't exist.
	 * @return The parameter value as a {@code double}.
	 * @throws JSONRPC2Error On a bad parameter type or {@code null} value ({@link JSONRPC2Error#INVALID_PARAMS}). */
	...
	public List<Object> getList(final String name, final boolean allowNull)
			throws JSONRPC2Error {
		return get(name, List.class, allowNull);
	}
	...
	public List<Object> getOptList(final String name,
			...
			throws JSONRPC2Error {
		return getOpt(name, List.class, allowNull, defaultValue);
	}
	...
	public Map<String, Object> getMap(final String name, final boolean allowNull)
			throws JSONRPC2Error {
		try {
			return get(name, Map.class, allowNull);
		} catch (ClassCastException e) {
			throw NamedParamsRetriever.newUnexpectedParameterTypeException(name);
		}
	}
	...
	public Map<String, Object> getOptMap(final String name,
			...
			throws JSONRPC2Error {
		try {
			return getOpt(name, Map.class, allowNull, defaultValue);
		} catch (ClassCastException e) {
			throw NamedParamsRetriever.newUnexpectedParameterTypeException(name);
		}
	}
