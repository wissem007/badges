 ...
 * <li>{@code params} The required method parameters (if any), which can be packed into a JSON array or object.
 * <li>{@code id} An identifier which is echoed back to the client with the response.
 ...
 * <ul>
 * <li>Pass a JSON-RPC 2.0 request string to the static {@link #parse} method, or
...
public class JSONRPC2Request extends JSONRPC2Message{
	...
	public static JSONRPC2Request parse(final String jsonString)
		...
		return JSONRPC2Request.parse(jsonString, false, false, false);
	}
	/** Parses a JSON-RPC 2.0 request string. This method is thread-safe.
	 * @param jsonString The JSON-RPC 2.0 request string, UTF-8 encoded. Must not be {@code null}.
	 * @param preserveOrder {@code true} to preserve the order of JSON object members in parameters.
	 * @return The corresponding JSON-RPC 2.0 request object.
	 * @throws JSONRPC2ParseException With detailed message if parsing failed. */
	public static JSONRPC2Request parse(final String jsonString,
			final boolean preserveOrder)
			throws JSONRPC2ParseException {
		return JSONRPC2Request.parse(jsonString, preserveOrder, false, false);
	}
	/** Parses a JSON-RPC 2.0 request string. This method is thread-safe.
	 * @param jsonString The JSON-RPC 2.0 request string, UTF-8 encoded. Must not be {@code null}.
	 * @param preserveOrder {@code true} to preserve the order of JSON object members in parameters.
	...
	public static JSONRPC2Request parse(final String jsonString,
			...
			throws JSONRPC2ParseException {
		return JSONRPC2Request.parse(jsonString, preserveOrder, ignoreVersion, false);
	}
	/** Parses a JSON-RPC 2.0 request string. This method is thread-safe.
	 * @param jsonString The JSON-RPC 2.0 request string, UTF-8 encoded. Must not be {@code null}.
	 * @param preserveOrder {@code true} to preserve the order of JSON object members in parameters.
	 ...
	 * @param method The name of the requested method. Must not be {@code null}.
	 * @param id The request identifier echoed back to the caller. The value must <a href="#map">map</a> to a JSON scalar ({@code null} and fractions, however, should be avoided). */
	 ...
	 * @param method The name of the requested method. Must not be {@code null}.
	 * @param positionalParams The positional (JSON array) parameters, {@code null} if none.
	 * @param id The request identifier echoed back to the caller. The value must <a href="#map">map</a> to a JSON scalar ({@code null} and fractions, however, should be avoided). */
	 ...
	 * @param namedParams The named (JSON object) parameters, {@code null} if none.
	 * @param id The request identifier echoed back to the caller. The value must <a href="#map">map</a> to a JSON scalar ({@code null} and fractions, however, should be avoided). */
	public JSONRPC2Request(final String method,
	...
	/** Gets the parameters type ({@link JSONRPC2ParamsType#ARRAY positional}, {@link JSONRPC2ParamsType#OBJECT named} or {@link JSONRPC2ParamsType#NO_PARAMS none}).
	 ...
	 * <p>
	 * This method was deprecated in version 1.30. Use {@link #getPositionalParams} or {@link #getNamedParams} instead.
	 * @return The parameters as {@code List<Object>} for positional (JSON array), {@code Map<String,Object>} for named (JSON object), or {@code null} if none. */
	@Deprecated
	 ...
	 * @since 1.30
	 * @return The positional (JSON array) parameters, {@code null} if none or named. */
	public List<Object> getPositionalParams() {
		return positionalParams;
	}
	/** Gets the named parameters.
	 * @since 1.30
	 * @return The named (JSON object) parameters, {@code null} if none or positional. */
	public Map<String, Object> getNamedParams() {
		return namedParams;
	}
	/** Sets the request parameters.
	 * <p>
	 * This method was deprecated in version 1.30. Use {@link #setPositionalParams} or {@link #setNamedParams} instead.
	 * @param params The parameters. For positional (JSON array) pass a {@code List<Object>}. For named (JSON object) pass a {@code Map<String,Object>}. If there are no parameters pass {@code null}. */
	@Deprecated
	 ...
	 * @since 1.30
	 * @param positionalParams The positional (JSON array) request parameters, {@code null} if none. */
	 ...
	 * @since 1.30
	 * @param namedParams The named (JSON object) request parameters, {@code null} if none. */
	public void setNamedParams(final Map<String, Object> namedParams) {
		if (namedParams == null) { return; }
		this.namedParams = namedParams;
	}
	/** Gets the request identifier.
	 * @return The request identifier ({@code Number}, {@code Boolean}, {@code String}) or {@code null}. */
	public Object getID() {
		return id;
	}
