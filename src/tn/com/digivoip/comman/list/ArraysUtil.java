...
public class ArraysUtil{
	...
	public static <T> T[] join(T[][] arrays) {
		...
		return ArraysUtil.join(componentType, arrays);
	}
	...
	public static char[] join(char[][] arrays) {
		if (arrays.length == 0) { return new char[0]; }
		if (arrays.length == 1) { return arrays[0]; }
		int length = 0;
	...
	public static short[] join(short[][] arrays) {
		if (arrays.length == 0) { return new short[0]; }
		if (arrays.length == 1) { return arrays[0]; }
		int length = 0;
	...
	public static long[] join(long[][] arrays) {
		if (arrays.length == 0) { return new long[0]; }
		if (arrays.length == 1) { return arrays[0]; }
		int length = 0;
	...
	public static float[] join(float[][] arrays) {
		if (arrays.length == 0) { return new float[0]; }
		if (arrays.length == 1) { return arrays[0]; }
		int length = 0;
	...
	public static boolean[] join(boolean[][] arrays) {
		if (arrays.length == 0) { return new boolean[0]; }
		if (arrays.length == 1) { return arrays[0]; }
		int length = 0;
	...
	public static <T> T[] remove(T[] buffer, int offset, int length) {
		@SuppressWarnings("unchecked")
		Class<T> componentType = (Class<T>) buffer.getClass().getComponentType();
		return ArraysUtil.remove(buffer, offset, length, componentType);
	}
	/** Removes sub-array. */
	@SuppressWarnings({ "unchecked" })
	...
	public static <T> T[] subarray(T[] buffer, int offset, int length) {
		@SuppressWarnings("unchecked")
		Class<T> componentType = (Class<T>) buffer.getClass().getComponentType();
		return ArraysUtil.subarray(buffer, offset, length, componentType);
	}
	/** Returns subarray. */
	@SuppressWarnings({ "unchecked" })
	...
	public static <T> T[] insert(T[] dest, T[] src, int offset) {
		...
		return ArraysUtil.insert(dest, src, offset, componentType);
	}
	...
	public static <T> T[] insertAt(T[] dest, T[] src, int offset) {
		Class<T> componentType = (Class<T>) dest.getClass().getComponentType();
		return ArraysUtil.insertAt(dest, src, offset, componentType);
	}
	/** Inserts one array into another at given offset. */
	@SuppressWarnings({ "unchecked" })
	public static <T> T[] insertAt(T[] dest, T[] src, int offset, @SuppressWarnings("rawtypes") Class componentType) {
	...
	public static boolean contains(byte[] array, byte value) {
		return ArraysUtil.indexOf(array, value) != -1;
	}
	...
	public static int indexOf(float[] array, float value) {
		for (int i = 0; i < array.length; i++) {
			if (Float.compare(array[i], value) == 0) { return i; }
		}
		return -1;
	}
	...
	public static int indexOf(double[] array, double value) {
		for (int i = 0; i < array.length; i++) {
			if (Double.compare(array[i], value) == 0) { return i; }
		}
		return -1;
	}
	...
	public static boolean contains(Object[] array, Object value, int startIndex) {
		return ArraysUtil.indexOf(array, value, startIndex) != -1;
	}
	// ---------------------------------------------------------------- indexof 2
	/** Finds the first occurrence in an array. */
	public static int indexOf(byte[] array, byte[] sub) {
		return ArraysUtil.indexOf(array, sub, 0, array.length);
	}
	public static boolean contains(byte[] array, byte[] sub) {
		return ArraysUtil.indexOf(array, sub) != -1;
	}
	/** Finds the first occurrence in an array from specified given position. */
	public static int indexOf(byte[] array, byte[] sub, int startIndex) {
		return ArraysUtil.indexOf(array, sub, startIndex, array.length);
	}
	/** Finds the first occurrence in an array from specified given position and upto given length. */
	...
	// ---------------------------------------------------------------- toString
	/** Converts an array to string. Elements are separated by comma and an empty space. Returned string contains no brackets. */
	public static String toString(Object[] array) {
		if (array == null) { return StringPool.NULL; }
