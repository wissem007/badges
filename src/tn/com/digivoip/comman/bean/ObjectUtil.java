...
import tn.com.digivoip.comman.reflect.ReflectUtil;

/** Various object utilities. */
@SuppressWarnings("rawtypes")
public class ObjectUtil{

	/** Safely compares two objects just like <code>equals()</code> would, except it allows any of the 2 objects to be <code>null</code>.
	...
	public static boolean equalsEx(Object obj1, Object obj2) {
		...
		if (obj1.getClass().isArray()) {
			if (obj2.getClass().isArray() == false) { return false; }
			return Arrays.equals((Object[]) obj1, (Object[]) obj2);
		}
		return obj1.equals(obj2);
	}
	/** Non-symmetric utility for comparing the types of two objects. Might be useful for {@link Object#equals(Object)} if <code>instanceof</code> is not used.
	...
	public static int length(Object obj) {
		...
		if (obj.getClass().isArray() == true) { return Array.getLength(obj); }
		return -1;
	}
	...
	public static boolean containsElement(Object obj, Object element) {
		...
		if (obj instanceof Collection) { return ((Collection) obj).contains(element); }
		if (obj instanceof Map) { return ((Map) obj).values().contains(element); }
		if (obj instanceof Iterator) {
			Iterator iter = (Iterator) obj;
			while (iter.hasNext()) {
				Object o = iter.next();
				if (ObjectUtil.equals(o, element)) { return true; }
			}
			return false;
		}
		if (obj instanceof Enumeration) {
