...
public class FastCharArrayWriter extends Writer{
	...
	/** Closing a <code>FastCharArrayWriter</code> has no effect. The methods in this class can be called after the stream has been closed without generating an <code>IOException</code>. */
	@Override
	public void close() {
		// nop
	}
