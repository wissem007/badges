...
public class GroupScriptsDefinition implements IDefinition, ParserDefinition {
	...
	public void addGroupScriptDefinition(GroupScriptDefinition groupScrip) {
		groupScrip.setWebDefinition(webDefinition);
		webDefinition.addGroupScriptDefinition(groupScrip);
	}
