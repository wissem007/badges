...
public class UIExtOrganigrammeRender extends UIExtGenericContainerRender {
	...
	public UIExtOrganigrammeRender(UIExtPanel renderComponent) {
		super(renderComponent, "Ext.ux.Organisation");
	}
