...
public interface Entities {
	...
	public final static String LAQUO = "&#171;"; // angle quotation mark,
	// left
	...
	public final static String RAQUO = "&#187;"; // angle quotation mark,
	// righ
	...
	public final static String ACIRC = "&#194;"; // capital A, circumflex
	// accent
	...
	public final static String ECIRC = "&#202;"; // capital E, circumflex
	// accent
	...
	public final static String ICIRC = "&#206;"; // captial I, circumflex
	// accent
	...
	public final static String OCIRC = "&#212;"; // capital O, circumflex
	// accent
	...
	public final static String UCIRC = "&#219;"; // capital U, circumflex
	// accent
	...
	public final static String aCIRC = "&#226;"; // small a, circumflex
	// accent
	...
	public final static String eCIRC = "&#234;"; // small e, circumflex
	// accent
	...
	public final static String iCIRC = "&#238;"; // small i, curcumflex
	// accent
	...
	public final static String oCIRC = "&#244;"; // small o, circumflex
	// accent
	...
	public final static String uCIRC = "&#251;"; // small u, circumflex
	// accent
	...
	public final static String ALPHA = "&#913;"; // greek capital letter
	// aplha
	public final static String BETA = "&#914;"; // greek capital letter beta
	public final static String GAMMA = "&#915;"; // greek capital letter
	// gamma
	public final static String DELTA = "&#916;"; // greek capital letter
	// delta
	...
	public final static String THETA = "&#920;"; // greek capital letter
	// theta
	public final static String IOTA = "&#921;"; // greek capital letter iota
	public final static String KAPPA = "&#922;"; // greek capital letter
	// kappa
	public final static String LAMDA = "&#923;"; // greek capital letter
	// lamda
	...
	public final static String SIGMA = "&#931;"; // greek capital letter
	// sigma
	...
	public final static String OMEGA = "&#937;"; // greek capital letter
	// omega
	...
	public final static String epsilon = "&#949;"; // greek small letter
	// epsilon
	...
	public final static String omicron = "&#959;"; // greek small letter
	// omicron
	...
	public final static String upsilon = "&#965;"; // greek small letter
	// upsilon
	...
	public final static String BULL = "&#8226;"; // bullet (small balck
	// circle)
	...
	// (imaginary part)
	public final static String REAL = "&#8476;"; // blackletter capital R
	// (real part)
	...
	public final static String CRARR = "&#8529;"; // downwards arrow with
	// corner leftwards
	...
	public final static String LANG = "&#9001;"; // left pointing angle
	// bracket
	public final static String RANG = "&#9002;"; // right pointing angle
	// bracket
	...
	public final static String SCARON = "&#339;"; // latin capital letter S
	// with caron
	...
	public final static String LSQUO = "&#8217;"; // left single quotation
	// mark
	public final static String RSQUO = "&#8218;"; // right single quotation
	// mark
	public final static String SBQUO = "&#8218;"; // single low-9 quotation
	// mark
	public final static String LDQUO = "&#8220;"; // left double quotation
	// mark
	public final static String RDQUO = "&#8221;"; // right double quotation
	// mark
	public final static String BDQUO = "&#8222;"; // double low-9 quotation
	// mark
	...
	public final static String LSAQUO = "&#8249;"; // single left-pointing
	// angle mark
