...
import static tn.com.smartsoft.commons.ref.ReferenceType.STRONG;
...
import tn.com.smartsoft.commons.utils.StringPool;
...
public class ReferenceMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
	...
	/**
	 * Tests weak and soft references for identity equality. Compares references to other references and wrappers. If o is a reference, this returns true if r == o or if r and o reference the same
	 * non-null object. If o is a wrapper, this returns true if r's referent is identical to the wrapped object.
	 */
	...
	/**
	 * Returns <code>true</code> if the specified value reference has been garbage collected. The value behind the reference is also passed in, rather than queried inside this method, to ensure that
	 * the return statement of this method will still hold true after it has returned (that is, a value reference exists outside of this method which will prevent that value from being garbage
	 * collected).
	 * 
