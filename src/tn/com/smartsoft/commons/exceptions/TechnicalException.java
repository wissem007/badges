...
public class TechnicalException extends RuntimeException implements Nestable {
	...
	public TechnicalException(int type, String msg) {
		super(msg);
		this.type = type;
	}
	...
	public TechnicalException(int type, Throwable cause) {
		super(cause.getMessage());
		if (cause instanceof TechnicalException) {
			TechnicalException technicalException = (TechnicalException) cause;
			this.cause = technicalException.getCause();
			this.type = technicalException.getType();
		} else {
			this.cause = cause;
			this.type = type;
		}
	...
	public TechnicalException(int type, String msg, Throwable cause) {
		super(msg);
		if (cause instanceof TechnicalException) {
			TechnicalException technicalException = (TechnicalException) cause;
			this.cause = technicalException.getCause();
